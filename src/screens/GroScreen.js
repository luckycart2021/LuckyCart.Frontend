    ...
    return ( 
        ...
        <div className="wrapper11">
          ...
          <img src="/images/sale5.png" alt="" className="image--cover2"> 
           ...
           <img src="/images/sale1.png" alt="" className="image--cover2" >
           </img></a>
         </div>
            <div>
           ...
           <img src="./images/ge.jpg" alt="" className="image--cover2" >
           </img></a>
         ...
         <div className="topic6">BOYZ TRENDS</div>       
           ...
           <img src="./images/BE.jpg" alt="" className="image--cover2">
           </img></a>
...
/*<div className="sider">
<a href="http://localhost:3000/" ><img src="./images/lt.jpg" alt=""/></a>
</div>
<div className="sider">
<a href="http://localhost:3000/" ><img src="./images/lp.jpg" alt=""/></a>
</div>*/